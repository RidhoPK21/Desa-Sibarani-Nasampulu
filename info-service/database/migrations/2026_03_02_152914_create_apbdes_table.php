...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('apbdes', function (Blueprint $table) {
            ...
            $table->decimal('jaminan_sosial_aparatur', 15, 2)->default(0);
            $table->decimal('operasional_pemerintahan_desa', 15, 2)->default(0);
            ...
            $table->decimal('sarana_prasarana_pendidikan', 15, 2)->default(0);
            $table->decimal('sarana_prasarana_perpustakaan', 15, 2)->default(0);
            $table->decimal('pengelolaan_perpustakaan', 15, 2)->default(0);
            $table->decimal('penyelenggaraan_posyandu', 15, 2)->default(0);
            ...
            $table->string('file')->nullable(); // Kolom Dokumen Fisik (PDF/Excel)
